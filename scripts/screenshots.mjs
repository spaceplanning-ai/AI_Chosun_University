...
const SCENARIOS = [
  ...
  },
  {
    ...
    shots: [
      ...
      /*
        고대비 화면. 접근성 기능은 켰을 때가 진짜 화면이라, 끈 모습만 찍어 두면
        색이 깨져도 알 수 없다. 찍고 나서 곧바로 되돌려 다음 캡처에 영향을 주지 않는다.
      */
      { clicks: ['고대비 화면 전환'], wait: 700, name: '10-키오스크-고대비' },
      { clicks: ['고대비 화면 전환'], wait: 500, name: '_고대비-되돌림' },
